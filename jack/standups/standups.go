...
func FindMany(db jack.DB, condition string, params ...interface{}) ([]*Standup, error) {
	var _o []*Standup
...
func FindOne(db jack.DB, condition string, params ...interface{}) (*Standup, error) {
	// sql select query, primary key provided by sequence
	sqlstr := `
	SELECT "id", "name", "slack_channel_id", "time", "timezone", "questions", "team_id", "created_at", "updated_at"
	FROM jack.standups
...
func UpdateMany(db jack.DB, standup *Standup, condition string, params ...interface{}) ([]*Standup, error) {
	var _o []*Standup

	// prepare the slices
	_c, _i, _v := jack.Slice(getColumns(standup), len(params))
