...
func Insert(db testjack.DB, teammateInput *TeammateInput) (*Teammate, error) {
	// get all the non-nil columns and prepare them for the query
	_c, _i, _v := testjack.Slice(getColumns(teammateInput), 0)
...
func FindByID(db testjack.DB, id string) (*Teammate, error) {
	// sql select query, primary key provided by sequence
	sqlstr := `
    SELECT "id", "slack_id", "username", "first_name", "last_name", "email", "avatar", "timezone", "created_at", "updated_at"
    FROM "jack.teammates"
...
func FindBySlackID(db testjack.DB, slackID string) (*Teammate, error) {
	// sql select query, primary key provided by sequence
	sqlstr := `
    SELECT "id", "slack_id", "username", "first_name", "last_name", "email", "avatar", "timezone", "created_at", "updated_at"
    FROM "jack.teammates"
...
func FindMany(db testjack.DB, where *WhereClause) (teammates []*Teammate, err error) {
	// sql select query, primary key provided by sequence
	sqlstr := `
  SELECT "id", "slack_id", "username", "first_name", "last_name", "email", "avatar", "timezone", "created_at", "updated_at"
  FROM "jack.teammates"
...
func Update(db testjack.DB, id string, teammateInput *TeammateInput) (*Teammate, error) {
...
func UpdateBySlackID(db testjack.DB, slackID string, teammateInput *TeammateInput) (*Teammate, error) {
	fields := getColumns(teammateInput)
...
func UpdateMany(db testjack.DB, where *WhereClause, teammateInput *TeammateInput) (teammates []*Teammate, err error) {
	// prepare the slices
	_c, _i, _v := testjack.Slice(getColumns(teammateInput), len(where.params))
...
func Upsert(db testjack.DB, teammateInput *TeammateInput) (*Teammate, error) {
	// get all the non-nil columns and prepare them for the query
	_c, _i, _v := testjack.Slice(getColumns(teammateInput), 0)
...
func UpsertBySlackID(db testjack.DB, teammateInput *TeammateInput) (*Teammate, error) {
	// get all the non-nil columns and prepare them for the query
	_c, _i, _v := testjack.Slice(getColumns(teammateInput), 0)
