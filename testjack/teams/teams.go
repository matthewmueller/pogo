...
func Insert(db testjack.DB, teamInput *TeamInput) (*Team, error) {
	// get all the non-nil columns and prepare them for the query
	_c, _i, _v := testjack.Slice(getColumns(teamInput), 0)
...
// Find a "Team" by "id"
func Find(db pogo.DB, id string) (*Team, error) {
...
func FindByID(db testjack.DB, id string) (*Team, error) {
	// sql select query, primary key provided by sequence
	sqlstr := `
    SELECT "id", "slack_team_id", "slack_team_access_token", "slack_bot_access_token", "slack_bot_id", "team_name", "scope", "email", "stripe_id", "active", "free_teammates", "cost_per_user", "trial_ends", "created_at", "updated_at"
    FROM "jack.teams"
...
func FindMany(db testjack.DB, where *WhereClause) (teams []*Team, err error) {
	// sql select query, primary key provided by sequence
	sqlstr := `
  SELECT "id", "slack_team_id", "slack_team_access_token", "slack_bot_access_token", "slack_bot_id", "team_name", "scope", "email", "stripe_id", "active", "free_teammates", "cost_per_user", "trial_ends", "created_at", "updated_at"
  FROM "jack.teams"
...
func Update(db testjack.DB, id string, teamInput *TeamInput) (*Team, error) {
...
func UpdateBySlackBotAccessToken(db testjack.DB, slackBotAccessToken string, teamInput *TeamInput) (*Team, error) {
	fields := getColumns(teamInput)
...
func UpdateBySlackTeamAccessToken(db testjack.DB, slackTeamAccessToken string, teamInput *TeamInput) (*Team, error) {
	fields := getColumns(teamInput)
...
func UpdateBySlackTeamID(db testjack.DB, slackTeamID string, teamInput *TeamInput) (*Team, error) {
	fields := getColumns(teamInput)
...
func UpdateMany(db testjack.DB, where *WhereClause, teamInput *TeamInput) (teams []*Team, err error) {
	// prepare the slices
	_c, _i, _v := testjack.Slice(getColumns(teamInput), len(where.params))
...
func Upsert(db testjack.DB, teamInput *TeamInput) (*Team, error) {
	// get all the non-nil columns and prepare them for the query
	_c, _i, _v := testjack.Slice(getColumns(teamInput), 0)
...
func UpsertBySlackBotAccessToken(db testjack.DB, teamInput *TeamInput) (*Team, error) {
	// get all the non-nil columns and prepare them for the query
	_c, _i, _v := testjack.Slice(getColumns(teamInput), 0)
...
func UpsertBySlackTeamAccessToken(db testjack.DB, teamInput *TeamInput) (*Team, error) {
	// get all the non-nil columns and prepare them for the query
	_c, _i, _v := testjack.Slice(getColumns(teamInput), 0)
...
func UpsertBySlackTeamID(db testjack.DB, teamInput *TeamInput) (*Team, error) {
	// get all the non-nil columns and prepare them for the query
	_c, _i, _v := testjack.Slice(getColumns(teamInput), 0)
