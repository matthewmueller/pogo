...
func (standupteammate *StandupTeammate) StandupID(standupID uuid.UUID) *StandupTeammate {
	standupteammate.columns.StandupID = testjack.DecodeUUID(standupID)
