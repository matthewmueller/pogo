...
func Insert(ctx context.Context, db jack.DB, teamInput *TeamInput) (*Team, error) {
...
func Find(ctx context.Context, db jack.DB, id string) (*Team, error) {
...
func FindBySlackBotAccessToken(ctx context.Context, db jack.DB, slackBotAccessToken string) (*Team, error) {
	// sql select query, primary key provided by sequence
	sqlstr := `
    SELECT "id", "slack_team_id", "slack_team_access_token", "slack_bot_access_token", "slack_bot_id", "team_name", "scope", "email", "stripe_id", "active", "free_teammates", "cost_per_user", "trial_ends", "created_at", "updated_at"
    FROM "jack"."teams"
...
func FindBySlackTeamAccessToken(ctx context.Context, db jack.DB, slackTeamAccessToken string) (*Team, error) {
	// sql select query, primary key provided by sequence
	sqlstr := `
    SELECT "id", "slack_team_id", "slack_team_access_token", "slack_bot_access_token", "slack_bot_id", "team_name", "scope", "email", "stripe_id", "active", "free_teammates", "cost_per_user", "trial_ends", "created_at", "updated_at"
    FROM "jack"."teams"
...
func FindBySlackTeamID(ctx context.Context, db jack.DB, slackTeamID string) (*Team, error) {
	// sql select query, primary key provided by sequence
	sqlstr := `
    SELECT "id", "slack_team_id", "slack_team_access_token", "slack_bot_access_token", "slack_bot_id", "team_name", "scope", "email", "stripe_id", "active", "free_teammates", "cost_per_user", "trial_ends", "created_at", "updated_at"
    FROM "jack"."teams"
...
func FindOne(ctx context.Context, db jack.DB, where *WhereClause) (*Team, error) {
	// sql select query, primary key provided by sequence
	sqlstr := `
  SELECT "id", "slack_team_id", "slack_team_access_token", "slack_bot_access_token", "slack_bot_id", "team_name", "scope", "email", "stripe_id", "active", "free_teammates", "cost_per_user", "trial_ends", "created_at", "updated_at"
  FROM "jack"."teams"
...
func FindWhere(ctx context.Context, db jack.DB, where *WhereClause) ([]*Team, error) {
	teams := []*Team{}
...
func FindAll(ctx context.Context, db jack.DB) ([]*Team, error) {
	teams := []*Team{}
...
func Update(ctx context.Context, db jack.DB, id string, teamInput *TeamInput) (*Team, error) {
...
func UpdateBySlackBotAccessToken(ctx context.Context, db jack.DB, slackBotAccessToken string, teamInput *TeamInput) (*Team, error) {
	fields := getColumns(teamInput)
...
func UpdateBySlackTeamAccessToken(ctx context.Context, db jack.DB, slackTeamAccessToken string, teamInput *TeamInput) (*Team, error) {
	fields := getColumns(teamInput)
...
func UpdateBySlackTeamID(ctx context.Context, db jack.DB, slackTeamID string, teamInput *TeamInput) (*Team, error) {
	fields := getColumns(teamInput)
...
func UpdateWhere(ctx context.Context, db jack.DB, where *WhereClause, teamInput *TeamInput) ([]*Team, error) {
	teams := []*Team{}
...
func DeleteBySlackBotAccessToken(ctx context.Context, db jack.DB, slackBotAccessToken string) error {
	// sql delete query
...
func DeleteBySlackTeamAccessToken(ctx context.Context, db jack.DB, slackTeamAccessToken string) error {
	// sql delete query
...
func DeleteBySlackTeamID(ctx context.Context, db jack.DB, slackTeamID string) error {
	// sql delete query
...
func Upsert(ctx context.Context, db jack.DB, teamInput *TeamInput) (*Team, error) {
	// get all the non-nil columns and prepare them for the query
	_c, _i, _v := jack.Slice(getColumns(teamInput), 0)
...
func UpsertBySlackBotAccessToken(ctx context.Context, db jack.DB, teamInput *TeamInput) (*Team, error) {
	// get all the non-nil columns and prepare them for the query
	_c, _i, _v := jack.Slice(getColumns(teamInput), 0)
...
func UpsertBySlackTeamAccessToken(ctx context.Context, db jack.DB, teamInput *TeamInput) (*Team, error) {
	// get all the non-nil columns and prepare them for the query
	_c, _i, _v := jack.Slice(getColumns(teamInput), 0)
...
func UpsertBySlackTeamID(ctx context.Context, db jack.DB, teamInput *TeamInput) (*Team, error) {
	// get all the non-nil columns and prepare them for the query
	_c, _i, _v := jack.Slice(getColumns(teamInput), 0)
