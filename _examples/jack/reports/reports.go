...
func FindWhere(db jack.DB, where *WhereClause) ([]*Report, error) {
	reports := []*Report{}
...
func FindAll(db jack.DB) ([]*Report, error) {
	reports := []*Report{}
...
func UpdateWhere(db jack.DB, where *WhereClause, reportInput *ReportInput) ([]*Report, error) {
	reports := []*Report{}
