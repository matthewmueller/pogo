...
func FindWhere(db jack.DB, where *WhereClause) ([]*Standup, error) {
	standups := []*Standup{}
...
func FindAll(db jack.DB) ([]*Standup, error) {
	standups := []*Standup{}
...
func UpdateWhere(db jack.DB, where *WhereClause, standupInput *StandupInput) ([]*Standup, error) {
	standups := []*Standup{}
