...
func Insert(ctx context.Context, db jack.DB, standupTeammateInput *StandupTeammateInput) (*StandupTeammate, error) {
...
func Find(ctx context.Context, db jack.DB, standupID string, teammateID string) (*StandupTeammate, error) {
...
func Update(ctx context.Context, db jack.DB, standupID string, teammateID string, standupTeammateInput *StandupTeammateInput) (*StandupTeammate, error) {
...
func Delete(ctx context.Context, db jack.DB, standupID string, teammateID string) error {
	// sql query
	const sqlstr = `
