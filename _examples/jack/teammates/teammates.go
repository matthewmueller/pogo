...
func Insert(ctx context.Context, db jack.DB, teammateInput *TeammateInput) (*Teammate, error) {
...
func Find(ctx context.Context, db jack.DB, id string) (*Teammate, error) {
...
func FindBySlackID(ctx context.Context, db jack.DB, slackID string) (*Teammate, error) {
	// sql select query, primary key provided by sequence
	sqlstr := `
    SELECT "id", "slack_id", "username", "first_name", "last_name", "email", "avatar", "timezone", "created_at", "updated_at"
    FROM "jack"."teammates"
...
func FindOne(ctx context.Context, db jack.DB, where *WhereClause) (*Teammate, error) {
	// sql select query, primary key provided by sequence
	sqlstr := `
  SELECT "id", "slack_id", "username", "first_name", "last_name", "email", "avatar", "timezone", "created_at", "updated_at"
  FROM "jack"."teammates"
...
func FindWhere(ctx context.Context, db jack.DB, where *WhereClause) ([]*Teammate, error) {
	teammates := []*Teammate{}
...
func FindAll(ctx context.Context, db jack.DB) ([]*Teammate, error) {
	teammates := []*Teammate{}
...
func Update(ctx context.Context, db jack.DB, id string, teammateInput *TeammateInput) (*Teammate, error) {
...
func UpdateBySlackID(ctx context.Context, db jack.DB, slackID string, teammateInput *TeammateInput) (*Teammate, error) {
	fields := getColumns(teammateInput)
...
func UpdateWhere(ctx context.Context, db jack.DB, where *WhereClause, teammateInput *TeammateInput) ([]*Teammate, error) {
	teammates := []*Teammate{}
...
func DeleteBySlackID(ctx context.Context, db jack.DB, slackID string) error {
	// sql delete query
...
func Upsert(ctx context.Context, db jack.DB, teammateInput *TeammateInput) (*Teammate, error) {
	// get all the non-nil columns and prepare them for the query
	_c, _i, _v := jack.Slice(getColumns(teammateInput), 0)
...
func UpsertBySlackID(ctx context.Context, db jack.DB, teammateInput *TeammateInput) (*Teammate, error) {
	// get all the non-nil columns and prepare them for the query
	_c, _i, _v := jack.Slice(getColumns(teammateInput), 0)
