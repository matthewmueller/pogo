...
func FindWhere(db jack.DB, where *WhereClause) ([]*Teammate, error) {
	teammates := []*Teammate{}
...
func FindAll(db jack.DB) ([]*Teammate, error) {
	teammates := []*Teammate{}
...
func UpdateWhere(db jack.DB, where *WhereClause, teammateInput *TeammateInput) ([]*Teammate, error) {
	teammates := []*Teammate{}
