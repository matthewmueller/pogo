...
var _ pogo.Row = (*Teammate)(nil)

// Decode implements pogo.Row
func (t *Teammate) Decode(teammate interface{}) error {
	_teammate, ok := teammate.(*Teammate)
	if !ok {
		return fmt.Errorf(`teammate decode: "%T" is not a "*Teammate"`, teammate)
	}
	*_teammate = *t
	return nil
}
...
type Input struct {
	...
	username          *string
	firstName         *string
	nullableFirstName **string
	lastName          *string
	nullableLastName  **string
	email             *string
	nullableEmail     **string
	avatar            *string
	nullableAvatar    **string
	timezone          *string
}
...
// NullableFirstName will set the `first_name` to NULL if `firstName` is null
func (t *Input) NullableFirstName(firstName *string) *Input {
	t.nullableFirstName = &firstName
	return t
}
...
// NullableLastName will set the `last_name` to NULL if `lastName` is null
func (t *Input) NullableLastName(lastName *string) *Input {
	t.nullableLastName = &lastName
	return t
}
...
// NullableEmail will set the `email` to NULL if `email` is null
func (t *Input) NullableEmail(email *string) *Input {
	t.nullableEmail = &email
	return t
}
...
// NullableAvatar will set the `avatar` to NULL if `avatar` is null
func (t *Input) NullableAvatar(avatar *string) *Input {
	t.nullableAvatar = &avatar
	return t
}
...
func (t *Input) columns() map[string]interface{} {
	...
	if t.nullableFirstName != nil {
		columns["first_name"] = *t.nullableFirstName
	}
	if t.firstName != nil {
		columns["first_name"] = *t.firstName
	}

	if t.nullableLastName != nil {
		columns["last_name"] = *t.nullableLastName
	}
	if t.lastName != nil {
		columns["last_name"] = *t.lastName
	}

	if t.nullableEmail != nil {
		columns["email"] = *t.nullableEmail
	}
	if t.email != nil {
		columns["email"] = *t.email
	}

	if t.nullableAvatar != nil {
		columns["avatar"] = *t.nullableAvatar
	}
	if t.avatar != nil {
...
func (t *Input) Insert(db pogo.DB) (pogo.Row, error) {
	return Insert(db, t)
}
...
func (f *Filter) TeamIDIn(v ...int) *Filter {
	...
	f.formats = append(f.formats, fmt.Sprintf(`"team_id" IN (%s)`, strings.Join(rs, `, `)))
	for _, i := range v {
		f.values = append(f.values, i)
	}
	return f
...
func (f *Filter) TeamIDNotIn(v ...int) *Filter {
	...
	f.formats = append(f.formats, fmt.Sprintf(`"team_id" NOT IN (%s)`, strings.Join(rs, `, `)))
	for _, i := range v {
		f.values = append(f.values, i)
	}
	return f
...
func (f *Filter) SlackIDNotIn(v ...string) *Filter {
	...
	f.formats = append(f.formats, fmt.Sprintf(`"slack_id" NOT IN (%s)`, strings.Join(rs, `, `)))
	for _, i := range v {
		f.values = append(f.values, i)
	}
	return f
...
func (f *Filter) UsernameNotIn(v ...string) *Filter {
	...
	f.formats = append(f.formats, fmt.Sprintf(`"username" NOT IN (%s)`, strings.Join(rs, `, `)))
	for _, i := range v {
		f.values = append(f.values, i)
	}
	return f
...
func (f *Filter) FirstNameNotIn(v ...string) *Filter {
	...
	f.formats = append(f.formats, fmt.Sprintf(`"first_name" NOT IN (%s)`, strings.Join(rs, `, `)))
	for _, i := range v {
		f.values = append(f.values, i)
	}
	return f
...
// NullableFirstName nullable first_name equals
func (f *Filter) NullableFirstName(v *string) *Filter {
	if v == nil {
		f.formats = append(f.formats, `"first_name" IS NULL`)
		return f
	}
	f.formats = append(f.formats, `"first_name" = %s`)
	f.values = append(f.values, v)
...
// NullableFirstNameNot nullable first_name is not equal
func (f *Filter) NullableFirstNameNot(v *string) *Filter {
	if v == nil {
		f.formats = append(f.formats, `"first_name" IS NOT NULL`)
		return f
	}
	f.formats = append(f.formats, `"first_name" != %s`)
	f.values = append(f.values, v)
...
func (f *Filter) LastNameNotIn(v ...string) *Filter {
	...
	f.formats = append(f.formats, fmt.Sprintf(`"last_name" NOT IN (%s)`, strings.Join(rs, `, `)))
	for _, i := range v {
		f.values = append(f.values, i)
	}
	return f
...
// NullableLastName nullable last_name equals
func (f *Filter) NullableLastName(v *string) *Filter {
	if v == nil {
		f.formats = append(f.formats, `"last_name" IS NULL`)
		return f
	}
	f.formats = append(f.formats, `"last_name" = %s`)
	f.values = append(f.values, v)
...
// NullableLastNameNot nullable last_name is not equal
func (f *Filter) NullableLastNameNot(v *string) *Filter {
	if v == nil {
		f.formats = append(f.formats, `"last_name" IS NOT NULL`)
		return f
	}
	f.formats = append(f.formats, `"last_name" != %s`)
	f.values = append(f.values, v)
...
// NullableEmail nullable email equals
func (f *Filter) NullableEmail(v *string) *Filter {
	if v == nil {
		f.formats = append(f.formats, `"email" IS NULL`)
		return f
	}
	f.formats = append(f.formats, `"email" = %s`)
	f.values = append(f.values, v)
...
// NullableEmailNot nullable email is not equal
func (f *Filter) NullableEmailNot(v *string) *Filter {
	if v == nil {
		f.formats = append(f.formats, `"email" IS NOT NULL`)
		return f
	}
	f.formats = append(f.formats, `"email" != %s`)
	f.values = append(f.values, v)
...
func (f *Filter) AvatarNotIn(v ...string) *Filter {
	...
	f.formats = append(f.formats, fmt.Sprintf(`"avatar" NOT IN (%s)`, strings.Join(rs, `, `)))
	for _, i := range v {
		f.values = append(f.values, i)
	}
	return f
...
// NullableAvatar nullable avatar equals
func (f *Filter) NullableAvatar(v *string) *Filter {
	if v == nil {
		f.formats = append(f.formats, `"avatar" IS NULL`)
		return f
	}
	f.formats = append(f.formats, `"avatar" = %s`)
	f.values = append(f.values, v)
...
// NullableAvatarNot nullable avatar is not equal
func (f *Filter) NullableAvatarNot(v *string) *Filter {
	if v == nil {
		f.formats = append(f.formats, `"avatar" IS NOT NULL`)
		return f
	}
	f.formats = append(f.formats, `"avatar" != %s`)
	f.values = append(f.values, v)
...
func (f *Filter) TimezoneNotIn(v ...string) *Filter {
	...
	f.formats = append(f.formats, fmt.Sprintf(`"timezone" NOT IN (%s)`, strings.Join(rs, `, `)))
	for _, i := range v {
		f.values = append(f.values, i)
	}
	return f
...
// InsertMany "teammates" into the "jack"."teammates"
func InsertMany(db pogo.DB, teammates ...*Input) ([]*Teammate, error) {
	_teammates := []*Teammate{}
	for _, teammate := range teammates {
		_teammate, err := Insert(db, teammate)
		if err != nil {
			return _teammates, err
		}
		_teammates = append(_teammates, _teammate)
	}
	return _teammates, nil
}
...
// Update "teammates" rows in "jack"."teammates" by a condition, returning 1 result
func Update(db pogo.DB, teammate *Input, conds ...pogo.Condition) (*Teammate, error) {
	_s, _v, err := pogo.Conditions(conds...)
	if err != nil {
		return nil, err
	}
	...
	if len(_u) == 0 {
		return nil, errors.New("teammate.Update: no input provided")
	}
...
// UpdateMany updates "teammates" rows in "jack"."teammates" by conditions, returning all results
func UpdateMany(db pogo.DB, teammate *Input, conds ...pogo.Condition) ([]*Teammate, error) {
	teammates := []*Teammate{}
	...
	// return an error if no update input is provided
	if len(_u) == 0 {
		return nil, errors.New("teammate.UpdateMany: no input provided")
	}
...
func UpdateByID(db pogo.DB, id int, teammate *Input) (*Teammate, error) {
	...
	// return an error if no update input is provided
	if len(_u) == 0 {
		return nil, errors.New("teammate.UpdateByID: no input provided")
	}

	// sql query
	sqlstr := `UPDATE "jack"."teammates" ` +
		`SET ` + strings.Join(_u, ", ") + ` ` +
		`WHERE "id" = $1 ` +
		`RETURNING "id", "team_id", "slack_id", "username", "first_name", "last_name", "email", "avatar", "timezone"`
...
func UpdateBySlackID(db pogo.DB, slackID string, teammate *Input) (*Teammate, error) {
	...
	// return an error if no update input is provided
	if len(_u) == 0 {
		return nil, errors.New("teammate.UpdateBySlackID: no input provided")
	}
...
// UpsertByID inserts a `teammates`, updating the row if `ID` already exists.
func UpsertByID(db pogo.DB, id int, teammate *Input) (*Teammate, error) {
	// add values to input, overriding existing keys if present in the input
	...
	// return an error if no update input is provided
	if len(_u) == 0 {
		return nil, errors.New("teammate.UpsertByID: no input provided")
	}
...
// UpsertBySlackID inserts a `teammates`, updating the row if `"slack_id"` already exists.
