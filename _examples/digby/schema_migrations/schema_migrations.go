...
func FindMany(db digby.DB, where *WhereClause) ([]*SchemaMigration, error) {
...
func UpdateMany(db digby.DB, where *WhereClause, schemaMigrationInput *SchemaMigrationInput) ([]*SchemaMigration, error) {
	schemaMigrations := []*SchemaMigration{}
