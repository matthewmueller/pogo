...
// 	assert.Equal(t, "int", blogs.Columns[0].DataType.String())
...
// 	assert.Equal(t, "string", blogs.Columns[1].DataType.String())
...
// 	assert.Equal(t, "int", posts.Columns[0].DataType.String())
...
// 	assert.Equal(t, "int", posts.Columns[1].DataType.String())
...
// 	assert.Equal(t, "int", posts.Columns[2].DataType.String())
...
// 	assert.Equal(t, "string", posts.Columns[3].DataType.String())
...
// 	assert.Equal(t, "string", posts.Columns[4].DataType.String())
...
// 	assert.Equal(t, "int", posts.ForeignKeys[0].DataType.String())
...
// 	assert.Equal(t, "int", posts.Indexes[0].Columns[0].DataType.String())
...
// 	assert.Equal(t, "string", posts.Indexes[0].Columns[1].DataType.String())
// }
