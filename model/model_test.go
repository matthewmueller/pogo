...
import (
	...
	"github.com/matthewmueller/pogo/model"
...
// 	err := json.Unmarshal(bytes, &standup)
// 	if err != nil {
// 		t.Fatal(err)
// 	}
//
// 	standups := model.NewStandup(db)
// 	s, err := standups.Insert(&standup)
// 	if err != nil {
// 		t.Fatal(err)
// 	}
//
// 	assert.Equal(t, s.ID, "54a93908-08d8-4eb6-8cff-7a232aace285")
//
// 	// standupteammate := model.NewStandupTeammate(db)
// 	// standupteammate.Find
// }
