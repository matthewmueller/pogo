...
func Insert(db testdigby.DB, eventInput *EventInput) (*Event, error) {
	// get all the non-nil columns and prepare them for the query
	_c, _i, _v := testdigby.Slice(getColumns(eventInput), 0)
...
func FindByID(db testdigby.DB, id string) (*Event, error) {
	// sql select query, primary key provided by sequence
	sqlstr := `
    SELECT "id", "activity_id", "subject", "icon", "level", "source_table", "created_at"
    FROM "public.events"
...
func FindOne(db testdigby.DB, where *WhereClause) (*Event, error) {
	// sql select query, primary key provided by sequence
	sqlstr := `
  SELECT "id", "activity_id", "subject", "icon", "level", "source_table", "created_at"
  FROM "public.events"
...
func FindMany(db testdigby.DB, where *WhereClause) (events []*Event, err error) {
	// sql select query, primary key provided by sequence
	sqlstr := `
  SELECT "id", "activity_id", "subject", "icon", "level", "source_table", "created_at"
  FROM "public.events"
...
func Update(db testdigby.DB, id string, eventInput *EventInput) (*Event, error) {
...
func UpdateMany(db testdigby.DB, where *WhereClause, eventInput *EventInput) (events []*Event, err error) {
	// prepare the slices
	_c, _i, _v := testdigby.Slice(getColumns(eventInput), len(where.params))
...
func Upsert(db testdigby.DB, eventInput *EventInput) (*Event, error) {
	// get all the non-nil columns and prepare them for the query
	_c, _i, _v := testdigby.Slice(getColumns(eventInput), 0)
