...
// ErrActivityNotFound returned if the activity is not found
...
func Insert(db testdigby.DB, activityInput *ActivityInput) (*Activity, error) {
	// get all the non-nil columns and prepare them for the query
	_c, _i, _v := testdigby.Slice(getColumns(activityInput), 0)
...
func FindByID(db testdigby.DB, id string) (*Activity, error) {
	// sql select query, primary key provided by sequence
	sqlstr := `
    SELECT "id", "project_id", "creator_id", "subject", "icon", "event_count", "read_at", "created_at", "updated_at"
    FROM "public.activities"
...
func FindOne(db testdigby.DB, where *WhereClause) (*Activity, error) {
	// sql select query, primary key provided by sequence
	sqlstr := `
  SELECT "id", "project_id", "creator_id", "subject", "icon", "event_count", "read_at", "created_at", "updated_at"
  FROM "public.activities"
...
func FindMany(db testdigby.DB, where *WhereClause) (activities []*Activity, err error) {
	// sql select query, primary key provided by sequence
	sqlstr := `
  SELECT "id", "project_id", "creator_id", "subject", "icon", "event_count", "read_at", "created_at", "updated_at"
  FROM "public.activities"
...
func Update(db testdigby.DB, id string, activityInput *ActivityInput) (*Activity, error) {
...
func UpdateMany(db testdigby.DB, where *WhereClause, activityInput *ActivityInput) (activities []*Activity, err error) {
	// prepare the slices
	_c, _i, _v := testdigby.Slice(getColumns(activityInput), len(where.params))
...
func Upsert(db testdigby.DB, activityInput *ActivityInput) (*Activity, error) {
	// get all the non-nil columns and prepare them for the query
	_c, _i, _v := testdigby.Slice(getColumns(activityInput), 0)
