...
func Insert(db testdigby.DB, eventUserInput *EventUserInput) (*EventUser, error) {
	// get all the non-nil fields and prepare them for the query
	_c, _i, _v := testdigby.Slice(getColumns(eventUserInput), 0)
...
func Find(db testdigby.DB, eventID string, userID string) (*EventUser, error) {
  ...
  `
	testdigby.Log(sqlstr, eventID, userID)
...
func Update(db testdigby.DB, eventID string, userID string, eventUserInput *EventUserInput) (*EventUser, error) {
...
func Delete(db testdigby.DB, eventID string, userID string) error {
	// sql query
	const sqlstr = `
