...
// ErrToolNotFound returned if the tool is not found
...
func Insert(db testdigby.DB, toolInput *ToolInput) (*Tool, error) {
	// get all the non-nil columns and prepare them for the query
	_c, _i, _v := testdigby.Slice(getColumns(toolInput), 0)
...
func FindByID(db testdigby.DB, id string) (*Tool, error) {
	// sql select query, primary key provided by sequence
	sqlstr := `
    SELECT "id", "name", "icon", "tool_url", "activity_url", "event_url", "created_at", "updated_at"
    FROM "public.tools"
...
func FindOne(db testdigby.DB, where *WhereClause) (*Tool, error) {
	// sql select query, primary key provided by sequence
	sqlstr := `
  SELECT "id", "name", "icon", "tool_url", "activity_url", "event_url", "created_at", "updated_at"
  FROM "public.tools"
...
func FindMany(db testdigby.DB, where *WhereClause) (tools []*Tool, err error) {
	// sql select query, primary key provided by sequence
	sqlstr := `
  SELECT "id", "name", "icon", "tool_url", "activity_url", "event_url", "created_at", "updated_at"
  FROM "public.tools"
...
func Update(db testdigby.DB, id string, toolInput *ToolInput) (*Tool, error) {
...
func UpdateMany(db testdigby.DB, where *WhereClause, toolInput *ToolInput) (tools []*Tool, err error) {
	// prepare the slices
	_c, _i, _v := testdigby.Slice(getColumns(toolInput), len(where.params))
...
func Upsert(db testdigby.DB, toolInput *ToolInput) (*Tool, error) {
	// get all the non-nil columns and prepare them for the query
	_c, _i, _v := testdigby.Slice(getColumns(toolInput), 0)
