...
func Insert(db testdigby.DB, projectToolInput *ProjectToolInput) (*ProjectTool, error) {
	// get all the non-nil fields and prepare them for the query
	_c, _i, _v := testdigby.Slice(getColumns(projectToolInput), 0)
...
func Find(db testdigby.DB, projectID string, toolID string) (*ProjectTool, error) {
  ...
  `
	testdigby.Log(sqlstr, projectID, toolID)
...
func Update(db testdigby.DB, projectID string, toolID string, projectToolInput *ProjectToolInput) (*ProjectTool, error) {
...
func Delete(db testdigby.DB, projectID string, toolID string) error {
	// sql query
	const sqlstr = `
