...
func Insert(db testdigby.DB, schemaMigrationInput *SchemaMigrationInput) (*SchemaMigration, error) {
	// get all the non-nil columns and prepare them for the query
	_c, _i, _v := testdigby.Slice(getColumns(schemaMigrationInput), 0)
...
func FindByVersion(db testdigby.DB, version int) (*SchemaMigration, error) {
	// sql select query, primary key provided by sequence
	sqlstr := `
    SELECT "version"
    FROM "public.schema_migrations"
...
func FindOne(db testdigby.DB, where *WhereClause) (*SchemaMigration, error) {
	// sql select query, primary key provided by sequence
	sqlstr := `
  SELECT "version"
  FROM "public.schema_migrations"
...
func FindMany(db testdigby.DB, where *WhereClause) (schemaMigrations []*SchemaMigration, err error) {
	// sql select query, primary key provided by sequence
	sqlstr := `
  SELECT "version"
  FROM "public.schema_migrations"
...
func Update(db testdigby.DB, version int, schemaMigrationInput *SchemaMigrationInput) (*SchemaMigration, error) {
...
func UpdateMany(db testdigby.DB, where *WhereClause, schemaMigrationInput *SchemaMigrationInput) (schemaMigrations []*SchemaMigration, err error) {
	// prepare the slices
	_c, _i, _v := testdigby.Slice(getColumns(schemaMigrationInput), len(where.params))
...
func Delete(db testdigby.DB, version int) error {
	// sql query
...
func Upsert(db testdigby.DB, schemaMigrationInput *SchemaMigrationInput) (*SchemaMigration, error) {
	// get all the non-nil columns and prepare them for the query
	_c, _i, _v := testdigby.Slice(getColumns(schemaMigrationInput), 0)
