...
func Insert(db testdigby.DB, userInput *UserInput) (*User, error) {
	// get all the non-nil columns and prepare them for the query
	_c, _i, _v := testdigby.Slice(getColumns(userInput), 0)
...
func FindByEmail(db testdigby.DB, email string) (*User, error) {
	// sql select query, primary key provided by sequence
	sqlstr := `
    SELECT "id", "first_name", "last_name", "email", "password", "confirmed_at", "created_at", "updated_at"
    FROM "public.users"
...
func FindByID(db testdigby.DB, id string) (*User, error) {
	// sql select query, primary key provided by sequence
	sqlstr := `
    SELECT "id", "first_name", "last_name", "email", "password", "confirmed_at", "created_at", "updated_at"
    FROM "public.users"
...
func FindOne(db testdigby.DB, where *WhereClause) (*User, error) {
	// sql select query, primary key provided by sequence
	sqlstr := `
  SELECT "id", "first_name", "last_name", "email", "password", "confirmed_at", "created_at", "updated_at"
  FROM "public.users"
...
func FindMany(db testdigby.DB, where *WhereClause) (users []*User, err error) {
	// sql select query, primary key provided by sequence
	sqlstr := `
  SELECT "id", "first_name", "last_name", "email", "password", "confirmed_at", "created_at", "updated_at"
  FROM "public.users"
...
func Update(db testdigby.DB, id string, userInput *UserInput) (*User, error) {
...
func UpdateByEmail(db testdigby.DB, email string, userInput *UserInput) (*User, error) {
	fields := getColumns(userInput)
...
func UpdateMany(db testdigby.DB, where *WhereClause, userInput *UserInput) (users []*User, err error) {
	// prepare the slices
	_c, _i, _v := testdigby.Slice(getColumns(userInput), len(where.params))
...
func DeleteByEmail(db testdigby.DB, email string) error {
	// sql delete query
...
func Upsert(db testdigby.DB, userInput *UserInput) (*User, error) {
	// get all the non-nil columns and prepare them for the query
	_c, _i, _v := testdigby.Slice(getColumns(userInput), 0)
...
func UpsertByEmail(db testdigby.DB, userInput *UserInput) (*User, error) {
	// get all the non-nil columns and prepare them for the query
	_c, _i, _v := testdigby.Slice(getColumns(userInput), 0)
