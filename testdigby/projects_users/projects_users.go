...
func Insert(db testdigby.DB, projectUserInput *ProjectUserInput) (*ProjectUser, error) {
	// get all the non-nil fields and prepare them for the query
	_c, _i, _v := testdigby.Slice(getColumns(projectUserInput), 0)
...
func Find(db testdigby.DB, projectID string, userID string) (*ProjectUser, error) {
  ...
  `
	testdigby.Log(sqlstr, projectID, userID)
...
func Update(db testdigby.DB, projectID string, userID string, projectUserInput *ProjectUserInput) (*ProjectUser, error) {
	...
	// prepare the slices
	_c, _i, _v := testdigby.Slice(fields, 2)
...
func Delete(db testdigby.DB, projectID string, userID string) error {
	// sql query
	const sqlstr = `
